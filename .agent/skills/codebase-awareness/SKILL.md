...
- **Step 1**: Run `dir -Recurse` to see the file tree.
...
- **Step 4**: Acknowledge existing work specifically in your response (e.g., "I see you've already implemented X in `file.tsx`").
