...
1. **Check Prerequisites**
   ...
   - **Skill Check**: Read `view_file .agent/skills/tech-advisor/SKILL.md` to verify stack choices if not fully defined.
   - Ensure the required runtime (Node, Python, Go, etc.) and tools (GitHub CLI) are installed.
...
2. **Scaffold**
   ...
   - **Skill Check**: Read `view_file .agent/skills/repository-management/SKILL.md` to ensure correct gitignore and folder structure standards.
