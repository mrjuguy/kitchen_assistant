...
export const StorageCategorySelector: React.FC<
  StorageCategorySelectorProps
> = ({
  ...
  return (
    <View className="mb-10">
      ...
      <ScrollView
        ...
        className="flex-row pb-4 ml-[-20px] px-5"
      >
        {STORAGE_LOCATIONS.map((loc) => {
          ...
          return (
            <Pressable
              ...
              className={`flex-row items-center gap-2 px-5 py-3 rounded-2xl mr-3 border ${
                isSelected
            ...
            >
              ...
              <Text
                className={`font-bold ${isSelected ? "text-white" : "text-slate-700 dark:text-slate-200"}`}
              >
                {loc.label}
              </Text>
            </Pressable>
      ...
      <ScrollView
        horizontal
        showsHorizontalScrollIndicator={false}
        className="flex-row pb-2 ml-[-20px] px-5 mt-2"
      >
        {CATEGORIES.map((cat) => {
          ...
          return (
            <Pressable
              ...
              className={`flex-row items-center gap-2 px-4 py-2.5 rounded-xl mr-3 border ${
                isSelected
            ...
            >
              ...
              <Text
                className={`font-semibold text-sm ${isSelected ? "text-white dark:text-slate-900" : "text-slate-700 dark:text-slate-200"}`}
              >
                {cat.id}
              </Text>
            </Pressable>
