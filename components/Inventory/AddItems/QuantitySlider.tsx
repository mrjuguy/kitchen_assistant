    ...
    <View className="mb-6">
      ...
      <View className="flex-row justify-between items-center mb-5">
        ...
        <View className="flex-row bg-slate-200 dark:bg-slate-700 p-1 rounded-lg">
          <Text className="px-3 py-1 bg-white dark:bg-slate-600 rounded text-xs font-bold shadow-sm text-slate-900 dark:text-white">
            %
          </Text>
      ...
      <Text className="text-center text-slate-400 text-xs mt-4">
        Slide to estimate remaining amount
      </Text>
    </View>
  );
};
